export const simconnectDataType = {
    ...
    // Kodiak
    KODIAK_LANDING_LIGHT: 'KODIAK_LANDING_LIGHT',
    KODIAK_CABIN_LIGHT: 'KODIAK_CABIN_LIGHT',
    KODIAK_PITOT_HEAT_1: 'KODIAK_PITOT_HEAT_1',
    KODIAK_PITOT_HEAT_2: 'KODIAK_PITOT_HEAT_2',
    KODIAK_AUX_BUS: 'KODIAK_AUX_BUS',
    KODIAK_FUEL_PUMP: 'KODIAK_FUEL_PUMP',
    KODIAK_IGNITION: 'KODIAK_IGNITION',
    KODIAK_STARTER: 'KODIAK_STARTER',
    KODIAK_FUEL_SHUTOFF_LEFT: 'KODIAK_FUEL_SHUTOFF_LEFT',
    KODIAK_FUEL_SHUTOFF_RIGHT: 'KODIAK_FUEL_SHUTOFF_RIGHT',
    KODIAK_OXYGEN: 'KODIAK_OXYGEN',

    
    PROP_DEICE_SWITCH: 'PROP_DEICE_SWITCH',
    WINDSHIELD_DEICE_SWITCH: 'WINDSHIELD_DEICE_SWITCH',
    ENG_ANTI_ICE_1: 'ENG_ANTI_ICE_1',
    LIGHT_WING: 'LIGHT_WING',
    ALTERNATOR_1_ON: 'ALTERNATOR_1_ON',
    ALTERNATOR_2_ON: 'ALTERNATOR_2_ON'
